...
const PhilosophySection = () => {
  ...
  return (
    <section ref={ref} id="philosophy" className="bg-black py-28 md:py-40 px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span className="font-serif italic text-white/40">Innovation</span>
          <span className="text-white"> x </span>
          <span className="font-serif italic text-white/40">Vision</span>
        </motion.h2>
